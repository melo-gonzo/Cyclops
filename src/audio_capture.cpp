...
// WEB_AUDIO_HTML now lives in web/audio.html (compiled in as WEB_AUDIO_HTML via web/ codegen)
...
// WEB_PLAYER_JS now lives in web/player.js (compiled in as WEB_PLAYER_JS via web/ codegen)
...
// ms of each other.
// WEB_LIVE_HTML now lives in web/live.html (compiled in as WEB_LIVE_HTML via web/ codegen)
...
static void handleAudioPage() {
  audioServer->send_P(200, "text/html", WEB_AUDIO_HTML);
}

static void handleLivePage() {
  audioServer->send_P(200, "text/html", WEB_LIVE_HTML);
}

static void handlePlayerJs() {
  audioServer->send_P(200, "application/javascript", WEB_PLAYER_JS);
}
